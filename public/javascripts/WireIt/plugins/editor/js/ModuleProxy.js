(function() {
    ...
    /**
     * Module Proxy handle the drag/dropping from the module list to the layer (in the TopologyEditor)
     * @class ModuleProxy
     * @constructor
     * @param {HTMLElement} el
     * @param {WireIt.TopologyEditor} TopologyEditor
     */
    WireIt.ModuleProxy = function(el, TopologyEditor) {

        this._TopologyEditor = TopologyEditor;
    ...
    lang.extend(WireIt.ModuleProxy,YAHOO.util.DDProxy, {
        ...
        /**
         * Add the module to the TopologyEditor on drop on layer
         * @method onDragDrop
         */
        onDragDrop: function(e, ddTargets) {
            ...
            this._TopologyEditor.addModule( this._module ,[pos[0]-layerPos[0]+layer.el.scrollLeft, pos[1]-layerPos[1]+layer.el.scrollTop]);
        }
