/**
 * Extend the TopologyEditor with composable topologies
 * @module composable-plugin
 */

/**
 * The ComposableTopologyEditor 
 *
 * @class ComposableTopologyEditor
 * @extends WireIt.ComposableTopologyEditor
 * @constructor
 */
WireIt.ComposableTopologyEditor = function(options) {
	
	// Add the "input" and "output" modules
//	options.modules = WireIt.ComposableTopologyEditor.modules.concat(options.modules);
	
   WireIt.ComposableTopologyEditor.superclass.constructor.call(this, options);
};
 ...
 */
/*
WireIt.ComposableTopologyEditor.modules = [
	{
      "name": "input",
      "container": {
...
YAHOO.lang.extend(WireIt.ComposableTopologyEditor, WireIt.TopologyEditor, {
