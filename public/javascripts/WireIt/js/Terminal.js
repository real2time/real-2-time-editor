...
WireIt.Terminal.prototype = {
    ...
    render: function() {
        ...
        this.setPosition(this.offsetPosition, this.ddConfig);
     ...
     * TODO
     */
    setPosition: function(pos, ddConfig) {
        // Clear the current position
        this.el.style.left = "50%";
        this.el.style.top = (ddConfig.type=="input") ? "-15px" : "";
        this.el.style.right = "";
        this.el.style.bottom = (ddConfig.type=="output") ? "-15px" : "";
        this.el.style['margin-left'] = "-15px";

        if(pos) {
            // New version: {top: 32, left: 23}
            if( lang.isObject(pos) ) {
                for(var key in pos) {
